...
class CplSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('cpl')->insert([
            ...
            // PS 7
            ['id_cpl' => 19, 'id_kurikulum' => 7, 'nama_kode_cpl' => 'CPL-1', 'id_ps' => 7, 'desc_cpl_id' => 'Mampu menerapkan prinsip matematika, statistika, dan logika komputasi untuk menganalisis, memodelkan, serta menyelesaikan masalah berbasis teknologi informasi.', 'desc_cpl_en' => 'Able to apply the principles of mathematics, statistics, and computational logic to analyze, model, and solve information technology-based problems.'],
