...
class ProfilLulusanSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('profil_lulusan')->insert([
            ...
            ['id_pl'=>13,'id_kurikulum'=>7,'id_ps'=>7,'kode_pl'=>'PL-1','nama_pl_id'=>'Pengelola Data dan Informasi','nama_pl_en'=>'Data and Information Manager','desc_pl_id'=>'Mampu mengelola, menganalisis, dan memanfaatkan data serta informasi untuk menghasilkan wawasan yang mendukung pengambilan keputusan organisasi melalui penerapan analitik data, manajemen basis data, serta teknologi kecerdasan buatan dan pembelajaran mesin.','desc_pl_en'=>'Able to manage, analyze, and utilize data and information to generate insights that support organizational decision-making through the application of data analytics, database management, and artificial intelligence and machine learning technologies.','profesi'=>'Business Analyst, Data Analyst, Database Enginee, AI/ML Engineer'],
            ['id_pl'=>14,'id_kurikulum'=>7,'id_ps'=>7,'kode_pl'=>'PL-2','nama_pl_id'=>'Pengembang Perangkat Lunak','nama_pl_en'=>'Software Developer','desc_pl_id'=>'Mampu menganalisis kebutuhan, merancang, mengembangkan, mengintegrasikan, serta menguji perangkat lunak dan aplikasi digital dengan memperhatikan kualitas sistem, keamanan, dan pengalaman pengguna.','desc_pl_en'=>'Able to analyze requirements, design, develop, integrate, and test software systems and digital applications while considering system quality, security, and user experience.','profesi'=>'System Analyst, UI/UX Designer, Mobile Developer, Full-Stack Web Developer, Software Quality Assurance'],
            ['id_pl'=>15,'id_kurikulum'=>7,'id_ps'=>7,'kode_pl'=>'PL-3','nama_pl_id'=>'Pengembang dan Pengelola Infrastruktur dan Jaringan','nama_pl_en'=>'Infrastructure and Network Engineer','desc_pl_id'=>'Mampu merancang, mengimplementasikan, mengelola, serta mengamankan infrastruktur teknologi informasi, jaringan komputer, dan layanan komputasi awan untuk mendukung keandalan, keamanan, dan kinerja sistem organisasi.','desc_pl_en'=>'Able to design, implement, manage, and secure information technology infrastructure, computer networks, and cloud computing services to support the reliability, security, and performance of organizational systems.','profesi'=>'Cyber Security Engineer, Cloud Engineer, Network Engineer, System Administrator, IT DevOps Engineer'],
            ['id_pl'=>16,'id_kurikulum'=>7,'id_ps'=>7,'kode_pl'=>'PL-4','nama_pl_id'=>'Pengelola Sumber Daya Teknologi Informasi','nama_pl_en'=>'IT Resource Manager','desc_pl_id'=>'Mampu mengelola layanan, tata kelola, dan sumber daya teknologi informasi organisasi dengan menerapkan prinsip manajemen layanan TI, manajemen risiko, serta audit sistem informasi.','desc_pl_en'=>'Able to manage IT services, governance, and information technology resources within organizations by applying IT service management, risk management, and information systems auditing principles.','profesi'=>'IT Auditor, IT Service Manager'],
            ['id_pl'=>17,'id_kurikulum'=>7,'id_ps'=>7,'kode_pl'=>'PL-5','nama_pl_id'=>'Pengembang Usaha Bidang Teknologi Informasi','nama_pl_en'=>'IT Entrepreneur','desc_pl_id'=>'Mampu mengembangkan dan mengelola usaha berbasis teknologi informasi melalui pemanfaatan inovasi digital, pengembangan produk atau layanan TI, serta penerapan prinsip kewirausahaan dan manajemen bisnis.','desc_pl_en'=>'Able to develop and manage information technology–based businesses through digital innovation, development of IT products or services, and the application of entrepreneurship and business management principles.','profesi'=>'IT Entrepreneur, Startup Founder, Digital Product Innovator'],
