...
class ProfilLulusanSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('profil_lulusan')->insert([
            ...
            ['id_pl'=>13,'id_kurikulum'=>7,'id_ps'=>7,'kode_pl'=>'PL-1','nama_pl_id'=>'Pengelola Data dan Informasi','nama_pl_en'=>'Data and Information Manager','desc_pl_id'=>'','desc_pl_en'=>'','profesi'=>'Business Analyst, Data Analyst, Database Enginee, AI/ML Engineer'],
            ['id_pl'=>14,'id_kurikulum'=>7,'id_ps'=>7,'kode_pl'=>'PL-2','nama_pl_id'=>'Pengembang Perangkat Lunak','nama_pl_en'=>'Software Developer','desc_pl_id'=>'','desc_pl_en'=>'','profesi'=>'System Analyst, UI/UX Designer, Mobile Developer, Full-Stack Web Developer, Software Quality Assurance'],
            ['id_pl'=>15,'id_kurikulum'=>7,'id_ps'=>7,'kode_pl'=>'PL-3','nama_pl_id'=>'Pengembang dan Pengelola Infrastruktur dan Jaringan','nama_pl_en'=>'Infrastructure and Network Developer and Manager','desc_pl_id'=>'','desc_pl_en'=>'','profesi'=>'Cyber Security Engineer, Cloud Engineer, Network Engineer, System Administrator, IT DevOps Engineer'],
            ['id_pl'=>16,'id_kurikulum'=>7,'id_ps'=>7,'kode_pl'=>'PL-4','nama_pl_id'=>'Pengelola Sumber Daya Teknologi Informasi','nama_pl_en'=>'Information Technology Resource Manager','desc_pl_id'=>'','desc_pl_en'=>'','profesi'=>'IT Auditor, IT Service Manager'],
            ['id_pl'=>17,'id_kurikulum'=>7,'id_ps'=>7,'kode_pl'=>'PL-5','nama_pl_id'=>'Pengembang Usaha Bidang Teknologi Informasi','nama_pl_en'=>'Information Technology Entrepreneur','desc_pl_id'=>'','desc_pl_en'=>'','profesi'=>'IT Entrepreneur'],
