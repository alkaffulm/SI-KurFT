                ...
                @forelse ($evaluasi as $item)
                    <tr class="bg-white border-b hover:bg-gray-50 border-t border-gray-400">
                        ...
                        <td class="px-6 py-4 text-center flex gap-x-2">
                            <button wire:click="edit({{ $item->id_evaluasi_upm }})"                                    class="inline-flex items-center px-3 py-1.5 text-sm text-yellow-600 hover:text-white hover:bg-yellow-600 border border-yellow-600 rounded-lg transition">
                                <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"/>
                                </svg>
                                Edit
                            </button>
                            <button wire:click="delete({{ $item->id_evaluasi_upm }})" wire:confirm="Yakin ingin menghapus catatan ini?" class="inline-flex items-center px-3 py-1.5 text-sm text-red-600 hover:text-white hover:bg-red-600 border border-red-600 rounded-lg transition">
                                <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
