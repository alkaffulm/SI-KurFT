    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
        <ul class="space-y-1 font-medium">
                ...
                <li>
                    ...
                    <li>
                        <a href="{{ route('testing-mhs-cpl.index') }}"
                            ...
                            <svg class="w-5 h-5 flex-shrink-0 {{ request()->routeIs('testing-mhs-cpl.*') ? 'text-white' : 'text-gray-500' }}"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                            </svg>
                            <span class="ms-3 text-sm">
                                (Testing) Laporan CPL Mahasiswa
                            </span>
            ...
            @if ($userRole == 'admin')
                ...
                {{-- Evaluasi UPM --}}
                <li>
                    <a href="{{ route('admin.evaluasi-upm.index') }}"
                        class="flex items-center p-2 rounded-lg transition-all duration-200
                        {{ request()->routeIs('admin.evaluasi-upm.*') ? 'bg-biru-custom text-white' : 'text-gray-700 hover:bg-blue-50 hover:text-biru-custom' }}">
                        <svg class="w-5 h-5 flex-shrink-0 {{ request()->routeIs('admin.evaluasi-upm.*') ? 'text-white' : 'text-gray-500' }}"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                        </svg>
