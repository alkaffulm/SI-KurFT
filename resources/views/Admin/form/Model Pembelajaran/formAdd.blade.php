...
<head>
    ...
    <title>Tambah Model Pembelajaran</title>
        ...
        <main class="mt-20 mb-5 max-w-5xl mx-auto">
            ...
            <form action="{{ route('model-pembelajaran.store') }}" method="POST">
                ...
                <div class="bg-white p-8 sm:p-10 rounded-xl shadow-lg">
                    <div class="mb-10">
                        <h1 class="text-4xl font-bold text-gray-800">Tambah Model Pembelajaran</h1>
                    </div>
                    ...
                    <div class="space-y-10">
                        <div class="grid grid-cols-12 gap-x-6 gap-y-4">
                            <div class="col-span-12 sm:col-span-5">
                                <label for="nama_model_pembelajaran"
                                    class="block text-base font-medium text-gray-700 mb-2">
                                    Nama Model Pembelajaran <span class="text-red-500">*</span>
                                </label>
                                <input type="text" 
                                    id="nama_model_pembelajaran"
                                    name="nama_model_pembelajaran" 
                                    ...
                                    value="{{ old('nama_model_pembelajaran') }}"
                                    placeholder="Contoh: Case atau Project Based"
                                    required>
                                @error('nama_model_pembelajaran')
