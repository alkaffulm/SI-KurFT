...
<body class="bg-gray-100 font-sans">
    ...
    <div class="p-4 sm:p-8 sm:ml-64">
        <main class="mt-20 mb-5 max-w-5xl mx-auto">
            ...
            <form id="form-update" action="{{ route('model-pembelajaran.updateAll') }}" method="POST">
                @csrf
                @method('PUT')
    ...
    <script>
        document.getElementById('form-update').addEventListener('submit', function(e) {
            ...
            const deleteCheckboxes = document.querySelectorAll('input[name="delete_model_pembelajaran[]"]:checked');
