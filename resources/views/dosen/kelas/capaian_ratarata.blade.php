        ...
        <div class="bg-white p-4 rounded-xl shadow-lg">
            ...
            <div class="mt-5 mb-10 px-10">
                ...
                <p class="text-gray-500 text-base">
                    Grafik menampilkan rata-rata nilai tiap mahasiswa, dengan garis rata-rata kelas.
                </p>
            </div>

            <div class="w-full h-96 px-10 pb-8">
                    ...
                    <tbody>
                        @foreach($kelas->mahasiswa as $mhs)
                            <tr class="text-black bg-white hover:bg-gray-100 border-t border-gray-400">
                                <td class="text-center px-6 py-3 font-medium border-r border-gray-400">
                                    {{ $mhs->nim }}
                                </td>
                                <td class="text-center px-6 py-3 border-r border-gray-400">
                                    {{ $mhs->nama_lengkap }}
                                </td>
                                ...
                                @foreach($rencanaAsesmen as $ra)
                                    ...
                                    @foreach($cpmkForAsesmen as $bc)
                                        @php
                                            ...
                                            $nilai = $idCpmk
                                                ? ($nilaiIndex[$mhs->nim][$ra->id_rencana_asesmen][$idCpmk] ?? 0)
                                                : 0;
                                        @endphp
