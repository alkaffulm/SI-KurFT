...
class StoreRPSTopicRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'topics.*.aktivitas_pembelajaran.TM.selected_metode_pembelajaran' => 'required_if:topics.*.tipe,topik|nullable',
            'topics.*.aktivitas_pembelajaran.BM.selected_metode_pembelajaran' => 'required_if:topics.*.tipe,topik|nullable',
            'topics.*.aktivitas_pembelajaran.BT.selected_bentuk_penugasan' => 'required_if:topics.*.tipe,topik|nullable',
            'topics.*.aktivitas_pembelajaran.TM.jumlah_pertemuan' => 'required_if:topics.*.tipe,topik|nullable',
            'topics.*.aktivitas_pembelajaran.TM.jumlah_sks' => 'required_if:topics.*.tipe,topik|nullable',
            'topics.*.aktivitas_pembelajaran.BM.jumlah_pertemuan' => 'required_if:topics.*.tipe,topik|nullable',
            'topics.*.aktivitas_pembelajaran.BM.jumlah_sks' => 'required_if:topics.*.tipe,topik|nullable',
            'topics.*.aktivitas_pembelajaran.BT.jumlah_pertemuan' => 'required_if:topics.*.tipe,topik|nullable',
            'topics.*.aktivitas_pembelajaran.BT.jumlah_sks' => 'required_if:topics.*.tipe,topik|nullable',
